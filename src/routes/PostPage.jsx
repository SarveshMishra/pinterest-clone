...
<div className='post_main'>
    <div className='post_middle'>
      ...
      <div className='owner_post'>
        ...
        <h1>Smile High</h1>
        <p>For “Smile High” we teamed up to create some art for a good cause. The folks over at wesmilehigh.com are printing posters with all profits being donated to Leuchaemia and Lymphoma Research.The claim is brought to life with an colorful installation of l…</p>
